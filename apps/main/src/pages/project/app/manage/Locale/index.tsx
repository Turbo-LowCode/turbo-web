...
export interface LocaleEditTableProps {
  ...
  onChange?: (newData: readonly LocaleDataRecordType[]) => void
}

export const LocaleEditTable: FC<LocaleEditTableProps> = ({ value, onChange }) => {
  ...
  return (
    <EditableProTable<LocaleDataRecordType>
      ...
      toolBarRender={() => {
        return [
          <Button key='download' type='primary' ghost>
            下载语言模版
          </Button>,
